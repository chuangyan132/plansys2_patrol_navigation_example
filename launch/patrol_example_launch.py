...
def generate_launch_description():
    ...
    plansys2_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={'model_file': example_dir + '/pddl/patrol_noconnection_shot.pddl'}.items()
        )
    ...
    shot_cmd = Node(
        package='plansys2_patrol_navigation_example',
        executable='shot_action_node',
        name='shot_action_node',
        output='screen',
        parameters=[])
